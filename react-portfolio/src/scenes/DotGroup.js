...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
  const selectedStyles = `relative bg-pink before:absolute before:w-6 before:h-6 before:rounded-full before:border-2 before:border-pink before:left-[-50%] before:top-[-50%]`;
  return (
